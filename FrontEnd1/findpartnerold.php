                    ...
                    <div style="width:40%;float:left;text-align: center;">
                        ...
                        <div class="step">
                            ...
                            <table class="but1">
                                <tr>
                                    <td>
                                        <button style="color: gray;background-color: white;border: 0;font-size: large;font-weight: bold;">Denish Cha</button>
                                    </td>
                                </tr>
                            </table>
                            <!-- <div class="bush">
                        ...
                        <div class="ash">
                            ...
                            <div>
                                ...
                                <table class="but2">
                                    <tr>
                                        <td>
                                            <button style="color: gray;background-color: white;border: 0;font-size: large;font-weight: bold;">Ibrahim Konate</button>
                                        </td>
                                    </tr>
                                </table>
